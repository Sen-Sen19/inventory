...
<style>
    .form-container {
        ...
        width: 80%;
        max-width: 100%;
        margin: 50px 100px 50px 15%; /* Adjust right margin to move it to the right */
    }
    .form-header {
...
<div class="form-container">
  ...
  <form>
    <div class="card-body">
      <div class="row">
        <div class="col-6">
          <a href="#" class="btn btn-primary wide-button" data-toggle="modal" data-target="#scanning_manual">Scanning of Barcode</a>
        </div>
      </div>
    </div>
